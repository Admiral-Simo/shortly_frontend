...
const Benefits = () => {
  return (
    <section id="benefits">
      <div className="container md:space-x-3 pb-20 mx-auto flex md:flex-row flex-col space-y-20 md:space-y-0 justify-between items-center">
        <Benefit />
        <Benefit />
        <Benefit />
      </div>
...
const Benefit = () => {
  return (
    <div className="pt-20 px-8 pb-4 bg-white rounded-lg relative">
      <div className="absolute -top-10 left-10 p-5 rounded-full bg-veryDarkBlue">
        <FirstIcon />
      </div>
      <h5 className="text-2xl font-bold mb-8">Brand Recognition</h5>
